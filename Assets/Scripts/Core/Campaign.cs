...
namespace Height1079.Core
{
    ...
    public static class Campaign
    {
        ...
        public static readonly IReadOnlyList<Member> Roster = new List<Member>
        {
            ...
            M("dubinina", "Людмила Дубинина", "Люда", 20, "4-й курс стройфака УПИ; завхоз", false, "вела дневник", "деньги и продукты", "ранение в походе 1957 года", "фотографировала"),
            M("slobodin", "Рустем Слободин", "Рустик", 23, "инженер, выпускник мехфака", false, "спортсмен", "мандолина", "валенки"),
            M("doroshenko", "Юрий Дорошенко", "Юра", 21, "4-й курс радиофака УПИ", false, "история с медведем и геологическим молотком", "берёт тяжёлое"),
            ...
            M("thibeaux", "Николай Тибо-Бриньоль", "Коля", 23, "инженер, выпускник стройфака", false, "родился в лагере", "ироничный", "любимец группы"),
            M("kolevatov", "Александр Колеватов", "Саша", 24, "4-й курс физтеха УПИ", false, "аккуратист", "трубка", "вёл записи", "лаборант в Москве до УПИ"),
            M("zolotaryov", "Семён Золотарёв", "Саша", 38, "инструктор Коуровской турбазы; фронтовик", false, "старше всех", "татуировки", "присоединился перед выходом", "держится отдельно, профессионально"),
