...
- Мир 4,1 × 4,1 км вокруг Холатчахля на рельефе ArcticDEM 2 м (Terrain 2049²), 36 тыс. деревьев на местах из модели высоты полога, курумы, реконструкции палатки, лабаза, кедра с костром и настила по документам, архивный слой (F2). Данные, пайплайн и точность — в [docs/MAP.md](docs/MAP.md).
