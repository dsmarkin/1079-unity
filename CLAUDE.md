...
- **Что нужно и игре, и песочнице, кладём в общую сборку**, а не копируем. Песочница (`Sandbox`) намеренно не видит `Runtime` (сеть, мир, ночь), поэтому общий код — снег под ногами, дальше и тело — живёт в своих сборках (`Snow`, `Puppet`), на которые ссылаются обе.
